  ...
  return (
    <div className="fixed z-[10]  w-full  bg-white">
       <div>
        ...
        {/* navebare mobile  */}
        <nav className={`${isOpen? "translate-x-0" : "-translate-x-full"} lg:hidden bg-black text-white font-semibold text-center w-full h-fit z-10 flex flex-col absolute left-0 top-20 pt-8 pb-6 gap-8 transition-transform duration-500 ease-in-out`}>
